...
BEGIN
    ...
    BEGIN 
        IF (NOT EXISTS(SELECT * FROM USUARIOS WHERE CELULAR_USU = @CELULAR_USU))
        BEGIN
            INSERT INTO USUARIOS (NOMBRE_COMPLETO_USU, CELULAR_USU, ID_CIUDAD_FK, CORREO_ELECTRONICO_USU, CONTRASENA_USU)
        ...
        BEGIN
            SET @REGISTRADO = 0;
            SET @MENSAJE = 'El número de teléfono celular ya está en uso';
        END
    END
    ELSE
    BEGIN
